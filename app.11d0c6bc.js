(function(n) {
    function e(e) {
        for (var t, r, o = e[0], q = e[1], l = e[2], u = 0, p = []; u < o.length; u++)
            r = o[u],
            Object.prototype.hasOwnProperty.call(A, r) && A[r] && p.push(A[r][0]),
            A[r] = 0;
        for (t in q)
            Object.prototype.hasOwnProperty.call(q, t) && (n[t] = q[t]);
        d && d(e);
        while (p.length)
            p.shift()();
    ...
    function q(e) {
        ...
        return n[e].call(a.exports, a, a.exports, q),
        a.l = !0,
        a.exports
    }
    q.e = function(n) {
        ...
        r[n] ? e.push(r[n]) : 0 !== r[n] && a[n] && e.push(r[n] = new Promise((function(e, a) {
            for (var t = "css/" + ({}[n] || n) + "." + {
            ...
            }[n] + ".css", A = q.p + t, c = document.getElementsByTagName("link"), o = 0; o < c.length; o++) {
                var l = c[o]
                  , u = l.getAttribute("data-href") || l.getAttribute("href");
                if ("stylesheet" === l.rel && (u === t || u === A))
                    return e()
            }
    ...
    q.c = t,
    q.d = function(n, e, a) {
        q.o(n, e) || Object.defineProperty(n, e, {
            enumerable: !0,
            get: a
        })
    }
    ...
    "3c6a": function(n, e, a) {
        ...
        (function(c, o) {
            ...
            var a = function(n) {
                "undefined" !== typeof console && console && console.error && console.error(n)
            };
            if (e) {
                var t = "#eee"
                  , r = function() {
                  ...
                  , A = ["#5470c6", "#91cc75", "#fac858", "#ee6666", "#73c0de", "#3ba272", "#fc8452", "#9a60b4", "#ea7ccc"]
                  , c = {
                    color: A,
                ...
                c.categoryAxis.splitLine.show = !1,
                e.registerTheme("dark", c)
            } else
    ...
    "56d7": function(n, e, a) {
        ...
        function U(n, e) {
            if (n) {
                ...
                return "Object" === a && n.constructor && (a = n.constructor.name),
                "Map" === a || "Set" === a ? Array.from(n) : "Arguments" === a || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? B(n, e) : void 0
            }
        }
        function B(n, e) {
        ...
        var b = {
          ...
          , v = {
            pushWatchlist: function(n, e) {
                n.option_filter_category.unshift({
                    value: e.id,
                    label: e.name
                }),
                n.list_data_model_add.current_my_watchlist_id = n.option_filter_category[0].value
            },
        ...
        var D = function() {
          ...
          , T = function() {
            return Promise.all([a.e("chunk-2f7c1d16"), a.e("chunk-efae7d20")]).then(a.bind(null, "a9a9"))
        }
          , Y = function() {
            return Promise.all([a.e("chunk-2f7c1d16"), a.e("chunk-0459b389")]).then(a.bind(null, "8762"))
        }
          , S = function() {
            return Promise.all([a.e("chunk-2f7c1d16"), a.e("chunk-7b3d17aa")]).then(a.bind(null, "695f"))
        }
          , Z = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-12475118")]).then(a.bind(null, "7277"))
        }
          , X = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-4a5f46a6"), a.e("chunk-5dd324bd")]).then(a.bind(null, "5b62f"))
        }
          , M = function() {
            return a.e("chunk-68a0a3ee").then(a.bind(null, "7125"))
        }
          , z = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-4a5f46a6"), a.e("chunk-d9f77c88")]).then(a.bind(null, "d441e"))
        }
          , L = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-5a0b4458")]).then(a.bind(null, "8117"))
        }
          , O = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-1e2d6397")]).then(a.bind(null, "b0df"))
        }
          , G = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-35d5f21e")]).then(a.bind(null, "6550"))
        }
          , j = function() {
            return Promise.all([a.e("chunk-4a5f46a6"), a.e("chunk-774b7e09")]).then(a.bind(null, "fafa5"))
        }
          , H = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-22fb63a8")]).then(a.bind(null, "d600"))
        }
          , x = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-64004b8c")]).then(a.bind(null, "93b3"))
        }
          , E = function() {
          ...
          , R = function() {
            return Promise.all([a.e("chunk-8588f49c"), a.e("chunk-2d0c8ff5")]).then(a.bind(null, "56ec"))
        }
          , I = function() {
            return Promise.all([a.e("chunk-8588f49c"), a.e("chunk-680ad9a0")]).then(a.bind(null, "460a"))
        }
          , _ = function() {
          ...
          , Pn = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-65533dc4")]).then(a.bind(null, "dc02"))
        }
          , Nn = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-48cf5c99")]).then(a.bind(null, "eeca"))
        }
          , yn = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-465db71d")]).then(a.bind(null, "8a05"))
        }
          , Tn = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-38bc4bed")]).then(a.bind(null, "3292"))
        }
          , Yn = function() {
          ...
          , Zn = function() {
            return Promise.all([a.e("chunk-4cae93f2"), a.e("chunk-608ec18a")]).then(a.bind(null, "ec8e"))
        }
          , Xn = function() {
        ...
        se.beforeEach((function(n, e, a) {
            ...
            )) ? null != t && t.indexOf("admin") >= 0 && r < A ? a() : a({
                path: "/login",
                params: {
                    nextUrl: n.fullPath
                }
            ...
            )) ? null != t && t.indexOf("user") >= 0 && r < A ? a() : a({
                path: "/login",
                params: {
                    nextUrl: n.fullPath
                }
            ...
            )) ? null != t && t.indexOf("moderator") >= 0 && r < A ? a() : a({
                path: "/login",
                params: {
                    nextUrl: n.fullPath
                }
            ...
            )) ? null != t && t.indexOf("coworker") >= 0 && r < A ? a() : a({
                path: "/login",
                params: {
                    nextUrl: n.fullPath
                }
            ...
            )) ? null != t && t.indexOf("clan") >= 0 && r < A ? a() : (Q.commit("set", ["clanModal", !0]),
            a({
                path: e.fullPath,
                params: {
                    nextUrl: n.fullPath
                }
            })) : "/login" === n.path && localStorage.getItem("api_token") && r < A ? a({
                path: "/dashboard",
                params: {
                    nextUrl: n.fullPath
                }
        ...
        function Mt(n, e) {
            ...
            "HOSE" == e) {
                var a = 1.07 * n;
                return a >= 5e4 ? 100 * Math.floor(a / 100) / 1e3 : a >= 1e4 ? 50 * Math.floor(a / 50) / 1e3 : 10 * Math.floor(a / 10) / 1e3
            }
            if ("HNX" == e) {
                var t = 1.1 * n;
        ...
        function Lt(n, e, a) {
            ...
            var t = Mt(e, a)
              , r = zt(e, a);
            return 0 == n ? "text-nochange" : n >= t ? "text-ceilchange" : n > e ? "text-upchange" : n <= r ? "text-floorchange" : n < e ? "text-downchange" : "text-nochange"
        }
        function Ot(n, e, a) {
            n = parseFloat(n),
            e = parseFloat(e);
            var t = Mt(e, a)
              , r = zt(e, a);
            return 0 == n ? "nochange" : n >= t ? "ceilchange" : n > e ? "upchange" : n <= r ? "floorchange" : n < e ? "downchange" : "nochange"
        }
        function Gt(n, e, a) {
        ...
        function Et(n, e, a) {
            ...
            return n > 0 ? (n = Gt(n, e, a),
            '<span class="text-upchange">+'.concat(n).concat(t, "</span>\n    ")) : n < 0 ? (n = Gt(n, e, a),
            '<span class="text-downchange">'.concat(n).concat(t, "</span>")) : '<span class="text-nochange">'.concat(n).concat(t, "</span>")
        }
        function Jt(n, e, a) {
            var t = jt(a);
            return "i" == a || "c" == a ? '<span class="'.concat(t, '">+').concat(n, " (").concat(e, "%)</span>") : '<span class="'.concat(t, '">').concat(n, " (").concat(e, "%)</span>")
        }
        function Rt(n) {
            return n > 0 ? "text-upchange" : n < 0 ? "text-downchange" : "text-nochange"
        }
        var It = {
          ...
          , _t = new t["default"];
        t["default"].prototype.$apiAdress = "".concat("https://api.kungfustockspro.live", ":").concat("8443"),
